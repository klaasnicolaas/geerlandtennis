...
class SetsRelationManager extends RelationManager
{
            ...
            ->schema([
                ...
                Forms\Components\TextInput::make('set_number')
                    ...
                    ->rules([
                        ...
                        'integer',
                        'min:1',
                        new UniqueSetNumber(self::getOwnerRecord()->id),
                    ]),
                // Scores Section
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('set_number')->label('Set Number'),
                Tables\Columns\TextColumn::make('team_one_score')->label('Team 1 - Score'),
                Tables\Columns\TextColumn::make('team_two_score')->label('Team 2 - Score'),
                Tables\Columns\IconColumn::make('has_tie_break')->label('Tie Break')->boolean(),
            ])
            ->filters([
                //
            ])
